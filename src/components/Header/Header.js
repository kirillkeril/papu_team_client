  ...
  return (
    <header className={styles.mainContainer}>
      <div className={styles.logo}>
        ...
        <Input
          name={"search"}
          placeholder={"Найти среди 1000 товаров"}
      ...
      <menu className={styles.menuContainer}>
        ...
        <div className={styles.menuItem} onClick={() => navigate("/product")}>
          Продукт
        </div>
      ...
      <div className={styles.buttonsContainer}>
        {!store.isAuth && (
          <Button onClick={() => navigate("/login")} id={"auth"}>
            Вход/Регистрация
          </Button>
        )}
        <Button
          style={{ padding: "10px", marginLeft: "16px", marginRight: "16px" }}
        >
